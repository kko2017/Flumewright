...
- ✅ **Rebalance / dynamic assignment** — partition assignment adjusts as group members join/leave: a broker-side
...
systematic schedule exploration (Microsoft Coyote, active since M3c). Several real bugs have already been caught by
